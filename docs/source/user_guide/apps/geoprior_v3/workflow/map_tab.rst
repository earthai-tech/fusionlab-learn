.. _geoprior_v3_map_tab:

Map tab
=======

.. figure:: /_static/apps/geoprior_v3/08_map_tab.png
   :alt: Map tab.
   :width: 96%

   Map tab layout (example screenshot).

Purpose
-------

Explore spatial outputs (subsidence/head maps, hotspots, uncertainty, PIT and sharpness overlays) and link analytics to the results files.
...
Interactive map snapshots (if exported), figures, and derived analytics tables.
