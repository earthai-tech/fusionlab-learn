...
# ===================================================================
# 1) CORE EXPERIMENT SETUP (global, all stages)
# ===================================================================
...
# ===================================================================
# 2) DATA SCHEMA & CONVENTIONS (Stage-1 handshake semantics)
# ===================================================================

# -------------------------------------------------------------------
# 2.1 Column names and groundwater conventions
# -------------------------------------------------------------------
...
Z_SURF_COL = "z_surf"  # e.g. None or "dem_m" if available, else None
...
# ===================================================================
# 3) STAGE-1 PREPROCESSING & SCALING (Stage-1 -> NPZ)
# ===================================================================
...
# ===================================================================
# 4) FEATURE REGISTRY (Stage-1 -> Stage-2 handshake)
# ===================================================================
...
# -------------------------------------------------------------------
# 4.1 Optional numeric (dynamic) drivers
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 4.2 Optional categorical (static) features
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 4.3 Already-normalized numeric features
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 4.4 Future-known drivers (TFT-like)
# -------------------------------------------------------------------
...
# ===================================================================
# 5) CENSORING / EFFECTIVE-THICKNESS (H_eff) CONFIGURATION (Stage-1)
# ===================================================================
...
# ===================================================================
# 6) STAGE-2 MODEL ARCHITECTURE DEFAULTS (Stage-2)
# ===================================================================

# -------------------------------------------------------------------
# 6.1 Attention / architecture defaults
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 6.2 Probabilistic outputs and asymmetric loss weights
# -------------------------------------------------------------------
...
# ===================================================================
# 7) STAGE-2 PHYSICS CONFIGURATION (GeoPrior PINN block)
# ===================================================================

# -------------------------------------------------------------------
# 7.1 Which residuals are active + residual scaling
# -------------------------------------------------------------------
# PDE_MODE_CONFIG:
...
# Allow subsidence residual terms (if implemented/used downstream).
ALLOW_SUBS_RESIDUAL = True

# -------------------------------------------------------------------
# 7.2 Relative weights of each physics term (compile-time)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 7.3 Global physics-loss multiplier (offset) + scheduler
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 7.4 MV prior (units + schedule) + scalar LR multipliers
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 7.5 Physics bounds + time + coordinates (x,y)
# -------------------------------------------------------------------
# Bounds are used for:
...
# -------------------------------------------------------------------
# 7.6 Model->SI affine mapping for physics residuals
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 7.7 Consolidation drawdown gating (s_eq = Ss * delta_h * H)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 7.8 GEOPRIOR scalar parameters (initialization / closures)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 7.9 v3.2 residual discretization + scaling floors + Q conventions
# -------------------------------------------------------------------
...
# ===================================================================
# 8) STAGE-2 TRAINING STRATEGY (Physics-first vs Data-first)
# ===================================================================
# Strategy choices:
...
# Gradient clipping (training-step behavior)
CLIP_GLOBAL_NORM = 5.0


# ===================================================================
# 9) TRAINING LOOP DEFAULTS (non-tuner runs)
# ===================================================================
EPOCHS = 5
BATCH_SIZE = 32
LEARNING_RATE = 1e-4
...
# ===================================================================
# 10) HARDWARE / RUNTIME (TensorFlow)
# ===================================================================
...
# ===================================================================
# 11) AUDITING (Stage-1 / Stage-2 pipeline sanity checks)
# ===================================================================
...
# ===================================================================
# 12) STAGE-3 TUNING SEARCH SPACE (GeoPriorTuner)
# ===================================================================
